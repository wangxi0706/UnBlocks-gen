...
dfn = DFN()
dfn.set_FirstRecBlock([0, 0, 0], [10, 10, 10])
dfn.add_FractureSet()
# dfn.add_FractureSet()
...
# dfn.fractureSets[1].add_TriangularFracture(
...
generator = Generator()
generator.add_Fixed_Region([-0.1, -0.1, -0.1], [10.1, 10.1, 10.1])
# generator.generate_RockMass(dfn)
generator.generate_RockMass_Multi(dfn)
# generator.export_BlocksVtk("DIYBlock")

generator.export_BlocksDDAOpt("DIYBlock")
